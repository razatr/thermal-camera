...
Нажав на выпадающий список мы увидим окно выбора программ. По умочанию тут 3 программы нагрева. Их можно добавлять/удалять и настраивать нажав на вкладку "Настойки" </br>
